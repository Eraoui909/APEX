...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49937047297381197211)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937047746448197211)
,p_plug_template_id=>wwv_flow_imp.id(49937047297381197211)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937048146161197211)
,p_plug_template_id=>wwv_flow_imp.id(49937047297381197211)
,p_name=>'Tabs'
