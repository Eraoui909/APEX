...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49937031962335197205)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937032260825197206)
,p_plug_template_id=>wwv_flow_imp.id(49937031962335197205)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937032579839197206)
,p_plug_template_id=>wwv_flow_imp.id(49937031962335197205)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937032877693197206)
,p_plug_template_id=>wwv_flow_imp.id(49937031962335197205)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937033164076197206)
,p_plug_template_id=>wwv_flow_imp.id(49937031962335197205)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937033488641197206)
,p_plug_template_id=>wwv_flow_imp.id(49937031962335197205)
,p_name=>'Sub Regions'
