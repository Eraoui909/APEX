...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49936998825734197194)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936999198374197194)
,p_plug_template_id=>wwv_flow_imp.id(49936998825734197194)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936999427591197194)
,p_plug_template_id=>wwv_flow_imp.id(49936998825734197194)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936999775730197194)
,p_plug_template_id=>wwv_flow_imp.id(49936998825734197194)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937000035732197194)
,p_plug_template_id=>wwv_flow_imp.id(49936998825734197194)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937000336247197194)
,p_plug_template_id=>wwv_flow_imp.id(49936998825734197194)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937000671740197194)
,p_plug_template_id=>wwv_flow_imp.id(49936998825734197194)
,p_name=>'Sub Regions'
