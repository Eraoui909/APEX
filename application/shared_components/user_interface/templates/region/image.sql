...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49937006957336197196)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937007246054197197)
,p_plug_template_id=>wwv_flow_imp.id(49937006957336197196)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937007573213197197)
,p_plug_template_id=>wwv_flow_imp.id(49937006957336197196)
,p_name=>'Sub Regions'
