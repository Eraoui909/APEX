...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49937027006177197204)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937027348786197204)
,p_plug_template_id=>wwv_flow_imp.id(49937027006177197204)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937027674236197204)
,p_plug_template_id=>wwv_flow_imp.id(49937027006177197204)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937027984538197204)
,p_plug_template_id=>wwv_flow_imp.id(49937027006177197204)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937028260646197204)
,p_plug_template_id=>wwv_flow_imp.id(49937027006177197204)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937028555208197204)
,p_plug_template_id=>wwv_flow_imp.id(49937027006177197204)
,p_name=>'Sub Regions'
