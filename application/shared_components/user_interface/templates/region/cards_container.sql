...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49936977258333197185)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936977540752197186)
,p_plug_template_id=>wwv_flow_imp.id(49936977258333197185)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936977887143197186)
,p_plug_template_id=>wwv_flow_imp.id(49936977258333197185)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936978119336197186)
,p_plug_template_id=>wwv_flow_imp.id(49936977258333197185)
,p_name=>'Sub Regions'
