...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49937055280789197214)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937055531803197214)
,p_plug_template_id=>wwv_flow_imp.id(49937055280789197214)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937055893799197214)
,p_plug_template_id=>wwv_flow_imp.id(49937055280789197214)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937056321454197214)
,p_plug_template_id=>wwv_flow_imp.id(49937055280789197214)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937056742889197214)
,p_plug_template_id=>wwv_flow_imp.id(49937055280789197214)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937057041111197214)
,p_plug_template_id=>wwv_flow_imp.id(49937055280789197214)
