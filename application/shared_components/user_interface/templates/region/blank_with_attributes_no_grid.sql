...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49936971552486197183)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936971852073197183)
,p_plug_template_id=>wwv_flow_imp.id(49936971552486197183)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936972130493197184)
,p_plug_template_id=>wwv_flow_imp.id(49936971552486197183)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936972472403197184)
,p_plug_template_id=>wwv_flow_imp.id(49936971552486197183)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936972720938197184)
,p_plug_template_id=>wwv_flow_imp.id(49936971552486197183)
,p_name=>'Sub Regions'
