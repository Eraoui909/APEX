...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49936964973418197180)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936965220142197180)
,p_plug_template_id=>wwv_flow_imp.id(49936964973418197180)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936965581675197180)
,p_plug_template_id=>wwv_flow_imp.id(49936964973418197180)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936965854855197180)
,p_plug_template_id=>wwv_flow_imp.id(49936964973418197180)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936966152101197180)
,p_plug_template_id=>wwv_flow_imp.id(49936964973418197180)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936966469245197181)
,p_plug_template_id=>wwv_flow_imp.id(49936964973418197180)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936966736639197181)
,p_plug_template_id=>wwv_flow_imp.id(49936964973418197180)
,p_name=>'Sub Regions'
