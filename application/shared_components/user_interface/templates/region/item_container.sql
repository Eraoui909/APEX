...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49937029148075197205)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937029449701197205)
,p_plug_template_id=>wwv_flow_imp.id(49937029148075197205)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937029776675197205)
,p_plug_template_id=>wwv_flow_imp.id(49937029148075197205)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937030091269197205)
,p_plug_template_id=>wwv_flow_imp.id(49937029148075197205)
,p_name=>'Button Start'
