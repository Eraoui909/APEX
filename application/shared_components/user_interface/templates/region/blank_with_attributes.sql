...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49936970198569197183)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936970491683197183)
,p_plug_template_id=>wwv_flow_imp.id(49936970198569197183)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936970752465197183)
,p_plug_template_id=>wwv_flow_imp.id(49936970198569197183)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936971059545197183)
,p_plug_template_id=>wwv_flow_imp.id(49936970198569197183)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936971331614197183)
,p_plug_template_id=>wwv_flow_imp.id(49936970198569197183)
,p_name=>'Sub Regions'
