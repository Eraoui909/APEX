...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49937003401164197195)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937003714066197195)
,p_plug_template_id=>wwv_flow_imp.id(49937003401164197195)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937004029896197196)
,p_plug_template_id=>wwv_flow_imp.id(49937003401164197195)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937004336156197196)
,p_plug_template_id=>wwv_flow_imp.id(49937003401164197195)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937004655799197196)
,p_plug_template_id=>wwv_flow_imp.id(49937003401164197195)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937004981457197196)
,p_plug_template_id=>wwv_flow_imp.id(49937003401164197195)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
