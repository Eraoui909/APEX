...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49937034448010197206)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937034779502197206)
,p_plug_template_id=>wwv_flow_imp.id(49937034448010197206)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937035024992197207)
,p_plug_template_id=>wwv_flow_imp.id(49937034448010197206)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49937035328066197207)
,p_plug_template_id=>wwv_flow_imp.id(49937034448010197206)
,p_name=>'Sub Regions'
