...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(49936944846433197172)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936945119854197172)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936945402239197172)
,p_page_template_id=>wwv_flow_imp.id(49936944846433197172)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936945782425197172)
,p_page_template_id=>wwv_flow_imp.id(49936944846433197172)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936946099343197172)
,p_page_template_id=>wwv_flow_imp.id(49936944846433197172)
,p_name=>'Body Footer'
