...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(49936954876127197176)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936955184315197176)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936955489531197176)
,p_page_template_id=>wwv_flow_imp.id(49936954876127197176)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49936955702702197176)
,p_page_template_id=>wwv_flow_imp.id(49936954876127197176)
